...
import { portfolioItems, qboVideoDemos } from "@/lib/data";

export const metadata: Metadata = {
  title: "QuickBooks Online Company Setup — Case Study",
  description:
    "A complete QuickBooks Online bookkeeping cycle for a sample consulting company: setup, Chart of Accounts, reconciliation, and financial reporting, with video walkthroughs.",
};
      ...
      <section className="py-16 md:py-20">
        <Container className="max-w-3xl">
          ...
          <div className="mt-12 border-t border-stone-200 pt-10">
            <h2 className="font-display text-xl text-navy-900">Video Walkthroughs</h2>
            <p className="mt-2 text-sm leading-relaxed text-ink-500">
              Screen-recorded demonstrations of the workflow described below.
            </p>
            <div className="mt-7 flex flex-col gap-10">
              {qboVideoDemos.map((video) => (
                <div key={video.youtubeId}>
                  <h3 className="mb-3 font-display text-lg text-navy-900">{video.title}</h3>
