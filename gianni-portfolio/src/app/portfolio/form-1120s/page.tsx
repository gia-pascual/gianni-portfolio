...
export const metadata: Metadata = {
  ...
  description:
    "A mock S-corporation tax return case study completed during U.S. business tax preparation training.",
};

export default function Form1120SCaseStudy() {
  return (
    <>
      <CaseStudyHeader
        category="US Tax Preparation Training"
        title="Form 1120-S Case Study"
        meta="S-Corporation Return · Training Exercise"
      />
      <section className="py-16 md:py-20">
        <Container className="max-w-3xl">
          <p className="text-base leading-relaxed text-ink-700">
            As part of the U.S. Business Tax Preparation curriculum, I prepared a mock Form
            1120-S return for an S-corporation case study, covering shareholder allocations,
            income and expense classification, and the supporting schedules required for the
            filing.
          </p>
          <div className="mt-10 grid gap-8 border-t border-stone-200 pt-8 sm:grid-cols-2">
            <div>
              ...
              <ul className="mt-4 flex flex-col gap-3">
                {[
                  "Organizing S-corporation income and expense data",
                  "Working through shareholder allocation schedules",
                  "Completing Form 1120-S and supporting schedules",
