...
3. Netlify detects Next.js automatically and handles the adapter, build
   command, and publish directory for you — no manual plugin configuration
   needed. `netlify.toml` only specifies the build command as a safeguard.
